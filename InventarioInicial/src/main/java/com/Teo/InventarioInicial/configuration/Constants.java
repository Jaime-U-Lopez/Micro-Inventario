...
public class Constants {
    ...
    public static final String ALMACEN_NO_REGISTRADO = "El Almacen no se encuentra registrado";
    public static final String ARTICULO_NO_REGISTRADO = "El Articulo no se encuentra registrado";
    ...
    public static final String ALMACEN_ELIMINADO_CON_EXITO = "El Almacen fue eliminado con exito";
    public static final String ARTICULO_ELIMINADO_CON_EXITO = "El articulo fue eliminado con exito";
    public static final String ALMACEN_CREADO_CON_EXITO = "El almacen fue creado  con exito";
    public static final String ARTICULO_CREADO_CON_EXITO = "El Articulo fue creado  con exito";
    public static final String ARTICULO_YA_EXISTE = "Error el Articulo con ese Id ya existe en la base de datos  ";
    public static final String NO_EXISTE_AlMACEN = "Error, el Almacen ingresado no existe ";
